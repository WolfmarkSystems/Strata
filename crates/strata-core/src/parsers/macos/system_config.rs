...
use crate::parsers::plist_utils::{get_bool_from_plist, get_string_from_plist, parse_plist_data};
                ...
                .and_then(|v| v.as_array())
            {
                for item in items {
                    ...
                    artifacts.push(ParsedArtifact {
                        ...
                        source_path: path.to_string_lossy().to_string(),
                        json_data: serde_json::to_value(LoginItem { name, path: None })
                            .unwrap_or_default(),
                    });
                }
            }
