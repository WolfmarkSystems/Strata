...
mod tests {
    ...
    fn parses_text_with_path_lines() {
        ...
        let arts = parser
            .parse_file(Path::new(".fseventsd/0001"), text.as_bytes())
            .unwrap();
    ...
    fn carves_paths_from_binary_data() {
        ...
        data.extend_from_slice(
            b"junk junk /Users/victim/Desktop/evidence.doc more junk /System/Library/thing ",
        );
        let parser = MacosFseventsParser::new();
        let arts = parser
            .parse_file(Path::new(".fseventsd/0002"), &data)
            .unwrap();
        let carved: Vec<_> = arts
            .iter()
            .filter(|a| a.description.contains("carved"))
            .collect();
    ...
    fn empty_data_returns_empty() {
        let parser = MacosFseventsParser::new();
        let arts = parser
            .parse_file(Path::new(".fseventsd/0003"), b"")
            .unwrap();
