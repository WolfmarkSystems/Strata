...
impl ParserRegistry {
    ...
    pub fn register_default_parsers(&mut self) {
        ...
        self.register(Box::new(
            crate::parsers::macos::cron::MacosCronParser::new(),
        ));
        self.register(Box::new(
        ...
        self.register(Box::new(
            crate::parsers::macos::apps::MacosAppsParser::new(),
        ));
        self.register(Box::new(
            crate::parsers::macos::shell_history::MacosShellHistoryParser::new(),
        ));
        self.register(Box::new(
            crate::parsers::macos::auth::MacosAuthParser::new(),
        ));
        self.register(Box::new(
        ...
        self.register(Box::new(crate::parsers::ios::fstrata_fs::CheckrainFfsParser::new()));
        self.register(Box::new(
        ...
        self.register(Box::new(
            crate::parsers::linux::ir_strata_artifacts::LinuxIrArtifactsParser::new(),
        ));
        self.register(Box::new(
    ...
    pub fn parse_parallel(
        ...
        {
            use rayon::prelude::*;
            self.parsers.par_iter().flat_map(|parser| {
