...
pub use btrstrata_fs::{btrfs_detect, btrfs_fast_scan, BtrfsFastScanResult};
...
pub use xstrata_fs::{open_xfs, xfs_fast_scan, XfsFastScanResult, XfsFilesystem};

use crate::carving::regions::RegionSet;
...
pub fn ntfs_list_unallocated_regions(ntfs: &NtfsFastScanResult) -> anyhow::Result<RegionSet> {
    use crate::carving::regions::ScanRegion;
