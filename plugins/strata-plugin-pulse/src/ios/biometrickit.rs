...
pub fn matches(path: &Path) -> bool {
    ...
    n.starts_with("com.apple.biometrickit") || n == "biometrickittsync.db"
        || (util::path_contains(path, "biometrickit") && (n.ends_with(".db") || n.ends_with(".plist")))
}
...
pub fn parse(path: &Path) -> Vec<ArtifactRecord> {
    ...
    vec![ArtifactRecord {
        ...
        subcategory: "BiometricKit".to_string(), timestamp: None,
...
mod tests {
    ...
    fn matches_biometrickit() {
        assert!(matches(Path::new("/var/mobile/Library/BiometricKit/com.apple.BiometricKit.plist")));
