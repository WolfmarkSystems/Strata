//! iOS Minecraft — worlds, realms, multiplayer parser.
...
pub fn matches(path: &Path) -> bool {
    util::path_contains(path, "minecraft") && {
...
pub fn parse(path: &Path) -> Vec<ArtifactRecord> {
    ...
    out.push(ArtifactRecord {
        ...
        title: "Minecraft iOS database".to_string(),
        detail: format!("{} rows — worlds, realms, multiplayer sessions", total),
...
mod tests {
    ...
    #[test]
    fn matches_app() {
        assert!(matches(Path::new("/var/mobile/Containers/Data/Application/UUID/Library/minecraft/store.db")));
