...
pub fn matches(path: &Path) -> bool {
    util::name_is(path, &[
        "com.apple.emergencykit.plist",
        "com.apple.emergency.plist",
...
pub fn parse(path: &Path) -> Vec<ArtifactRecord> {
    ...
    vec![ArtifactRecord {
        ...
        subcategory: "Emergency SOS".to_string(), timestamp: None,
...
mod tests {
    ...
    fn matches_emergency_files() {
        assert!(matches(Path::new("/var/mobile/Library/Preferences/com.apple.emergencykit.plist")));
