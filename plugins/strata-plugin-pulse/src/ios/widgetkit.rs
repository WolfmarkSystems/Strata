//! iOS WidgetKit — `WidgetKit/` database.
//!
//! Widget configuration reveals which data the user cares about
...
mod tests {
    ...
    #[test]
    fn matches_widgetkit() {
        assert!(matches(Path::new("/var/mobile/Library/WidgetKit/store.db")));
        assert!(!matches(Path::new("/var/mobile/Library/SMS/sms.db")));
    }
    #[test]
    fn parses_rows() {
        let dir = tempdir().unwrap();
        let root = dir.path().join("WidgetKit");
