//! iOS Venmo deeper — transaction receipts parser.
...
pub fn parse(path: &Path) -> Vec<ArtifactRecord> {
    ...
    out.push(ArtifactRecord {
        ...
        subcategory: "SUBArtifactCategory::AccountsCredentials".to_string(), timestamp: None,
        title: "Venmo iOS receipt database".to_string(),
        detail: format!("{} rows — transaction receipts with amounts, recipients, notes", total),
