...
pub fn parse(path: &Path) -> Vec<ArtifactRecord> {
    ...
    out.push(ArtifactRecord {
        ...
        subcategory: "Slack".to_string(), timestamp: None,
        title: "Slack iOS database".to_string(),
        detail: format!("{} rows across {} tables — messages, channels, DMs", total, tables.len()),
...
mod tests {
    ...
    #[test]
    fn matches_slack_paths() {
        assert!(matches(Path::new("/var/mobile/Containers/Data/Application/UUID/Library/Slack/store.db")));
