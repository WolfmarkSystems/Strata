...
const TEXT_EXTENSIONS: &[&str] = &[
    // Text and logs
    "txt", "log", "csv", "tsv", "xml", "html", "htm", "json", "jsonl", "ndjson",
    "eml", "msg", "mbox", "cfg", "ini", "conf", "config", "env", "properties",
    // Code and scripts
    "py", "js", "ts", "rs", "go", "c", "cpp", "cc", "cxx", "h", "hpp",
    "java", "kt", "kts", "swift", "m", "mm", "rb", "pl", "pm", "php",
    "cs", "fs", "vb", "vbs", "lua", "r", "scala", "groovy", "dart",
    // Shell and automation
    "bat", "cmd", "sh", "bash", "zsh", "fish", "ps1", "psm1", "psd1",
    // Data and markup
    "md", "rst", "tex", "yaml", "yml", "toml", "gradle", "cmake",
    "sql", "reg", "inf", "manifest", "plist", "strings",
    // Web
    "css", "scss", "less", "svg", "jsx", "tsx", "vue", "svelte",
    // DevOps and config
    "dockerfile", "vagrantfile", "makefile", "rakefile",
    "tf", "hcl", "bicep", "csproj", "sln", "vcxproj",
    // Forensic-specific
    "evtx_export", "timeline", "ioc", "yara", "sigma", "suricata",
    "rules", "snort", "zeek",
];
